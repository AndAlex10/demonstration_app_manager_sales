...
class WidgetsCommons {
  ...
  static Widget createTextFormField(String hintText, String textReturn,
  ...
  static Widget buildCircle(String title, bool small){
    return Padding(
        ...
        child: Row(
          children: <Widget>[
            CircleAvatar(
              ...
              backgroundColor: small ? Colors.grey[500] : WidgetsCommons.buttonColor(),
            ),
            SizedBox(width: 5.0,),
